                        ...
                        transactions.map((transaction,index) => {
                            ...
                            return (
                                <div key={index} className="carousel-item  flex flex-col justify-center bg-base-100 shadow-xl rounded-xl p-5 gap-2">
                                    ...
                                    <p className='flex text-lg'>{transaction.wallet}...</p>
                                    ...
                                    <button className='flex text-2xl rounded-xl border outline-sky-200 w-1/2 justify-center p-3'>Give Tokens</button>
                                </div>
                            )
                        })
                    }
